 ...
 * @see <a href="https://developers.google.com/chart/interactive/docs/gallery/candlestickchart#Configuration_Options">Configuration Options</a>
 */
enum CandlestickCoreChartConfigOption {
    ...
    CANDLESTICK("candlestick", [DataType.OBJECT, DataType.MAP]),
