...
<script type="text/javascript">
    ...
    <g:if test="${!visualizationData.dynamicLoading}">google.setOnLoadCallback(<%=functionName%>);
    </g:if>
    ...
    function <%=functionName%>() {
        ...
        = new <%=visualizationData.visualization.object%>(document.getElementById('<%=visualizationData.elementId%>'));
        ...
        <%=visualizationData.name%>.
        draw(<%=visualizationData.name%>_data, <%=visualizationData.options%>);
