...
class GoogleVisualizationTests extends GrailsUnitTestCase {
    ...
    void testGetGoogleVisualizationForPackageNameUnknown() {
        try {
            ...
            fail("Unknown visualization should throw an exception")
        }
        catch(IllegalArgumentException e) {
            assertEquals 'Unknown Google visualization', e.message
        }
    }

    void testToString() {
        def expected = "GoogleVisualization{packageName='piechart', object='google.visualization.PieChart', configOptions='[backgroundColor:PieChartConfigOption{name='backgroundColor', types='[STRING, OBJECT]'}, borderColor:PieChartConfigOption{name='borderColor', types='[STRING, OBJECT]'}, colors:PieChartConfigOption{name='colors', types='[ARRAY]'}, enableTooltip:PieChartConfigOption{name='enableTooltip', types='[BOOLEAN]'}, focusBorderColor:PieChartConfigOption{name='focusBorderColor', types='[STRING, OBJECT]'}, height:PieChartConfigOption{name='height', types='[NUMBER]'}, is3D:PieChartConfigOption{name='is3D', types='[BOOLEAN]'}, legend:PieChartConfigOption{name='legend', types='[STRING]'}, legendBackgroundColor:PieChartConfigOption{name='legendBackgroundColor', types='[STRING, OBJECT]'}, legendFontSize:PieChartConfigOption{name='legendFontSize', types='[NUMBER]'}, legendTextColor:PieChartConfigOption{name='legendTextColor', types='[STRING, OBJECT]'}, pieJoinAngle:PieChartConfigOption{name='pieJoinAngle', types='[NUMBER]'}, pieMinimalAngle:PieChartConfigOption{name='pieMinimalAngle', types='[NUMBER]'}, title:PieChartConfigOption{name='title', types='[STRING]'}, titleColor:PieChartConfigOption{name='titleColor', types='[STRING, OBJECT]'}, titleFontSize:PieChartConfigOption{name='titleFontSize', types='[NUMBER]'}, tooltipFontSize:PieChartConfigOption{name='tooltipFontSize', types='[NUMBER]'}, tooltipHeight:PieChartConfigOption{name='tooltipHeight', types='[NUMBER]'}, tooltipWidth:PieChartConfigOption{name='tooltipWidth', types='[NUMBER]'}, width:PieChartConfigOption{name='width', types='[NUMBER]'}]', events='[onmouseover:AreaChartEvent{name='onmouseover'}, onmouseout:AreaChartEvent{name='onmouseout'}, ready:AreaChartEvent{name='ready'}, select:AreaChartEvent{name='select'}]'}"
        assertEquals expected, GoogleVisualization.PIE_CHART.toString() 
    }
}
